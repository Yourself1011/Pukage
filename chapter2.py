...
def Chapter2intro(endThing):
  ...
  waittype("Welcome to chapter 2  of Pukage. The previous chapter was just an introduction because you couldn't lose anything or die. Now you can. Things are about to get a lot more serious.")
...
def follow2():
  ...
  waittpe("Suddenly, you see something moving in the corner of your eye. You turn towards it and see the man enter a building in the distance.")

  options(
        ["Follow him into the building", "Keep exploring the town"],
        [follow3, explore],
    )
...
def explore():
  """exploring the city"""
  waittype("You decide to ingnore the man and explore the city. The lighthouse is to your left, the house you came from to your right, and the building the man went in in front of you.")
